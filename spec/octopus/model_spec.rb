...
describe Octopus::Model do
  ...
  describe "AR basic methods" do
    ...
    it "increment" do
      ...
      u.increment(:number)
      u.save()
      u = expect(User.using(:brazil).find_by_number(11)).not_to be_nil
    end
    ...
    it "decrement" do
      ...
      u.decrement(:number)
      u.save()
      u = expect(User.using(:brazil).find_by_number(9)).not_to be_nil
    end
    ...
    it "toggle" do
      ...
      u.toggle(:admin)
      u.save()
      u = expect(User.using(:brazil).find_by_name('Teste').admin).to be true
    end
